...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	0x31, 0x33, 0x91, 0x60, 0x52, 0x60, 0xd4, 0x60, 0x0e, 0x82, 0x71, 0x95, 0x8c, 0xb9, 0x44, 0xd1,
	0x74, 0x14, 0x17, 0xe4, 0xe7, 0x15, 0xa7, 0x0a, 0x49, 0x71, 0x71, 0x14, 0x41, 0xd9, 0x50, 0x3d,
	0x70, 0xbe, 0x51, 0x26, 0x97, 0x70, 0x48, 0x6a, 0x71, 0x89, 0x73, 0xb0, 0x67, 0x40, 0x51, 0x7e,
	0x45, 0x65, 0x70, 0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa, 0x50, 0x10, 0x17, 0x2f, 0x8a, 0x59, 0x42,
	0x72, 0x7a, 0x30, 0x97, 0xe9, 0x61, 0x73, 0x96, 0x94, 0x3c, 0x4e, 0x79, 0x88, 0x45, 0x4a, 0x0c,
	0x49, 0x6c, 0x60, 0x2f, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xa0, 0x7e, 0x3f, 0x28, 0xef,
	0x00, 0x00, 0x00,
}
...
func (c *testCSIProxyServiceClient) ComputeDouble(ctx context.Context, in *ComputeDoubleRequest, opts ...grpc.CallOption) (*ComputeDoubleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1alpha2.TestCSIProxyService/ComputeDouble", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestCSIProxyService_ComputeDouble_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1alpha2.TestCSIProxyService/ComputeDouble",
	}
...
var _TestCSIProxyService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "v1alpha2.TestCSIProxyService",
