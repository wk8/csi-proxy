...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) (packages generator.Packages) {
	...
	for _, group := range groups {
		...
		packages = append(packages, generatorPackagesForGroup(group, arguments.OutputBase)...)
	}
	return
}
...
func generatorPackagesForGroup(group *groupDefinition, outputBase string) generator.Packages {
